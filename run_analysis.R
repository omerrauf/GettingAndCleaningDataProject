...
## Download and unzip the dataset in destination folder.
...
## Apply rbind to concatenate by rows
...
## Use cbind to merge columns for complete data
...
## The activity names are taken from ActivityLabels
...
## independent tidy data set will be created
